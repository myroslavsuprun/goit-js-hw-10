...
(0, _refs.getRefs)().searchField.addEventListener("input", (0, _lodashDebounceDefault.default)(onSearchFormInput, DEBOUNCE_DELAY));
function onSearchFormInput(e) {
    if (e.target.value === "") {
        clearCountryInfo();
        clearCountryList();
        (0, _refs.getRefs)().countryInfo.classList.remove("card");
        return;
    }
    fetchCountriesResponse(e.target.value, createCountriesResponse, fetchCountriesFailureResponse);
}
...
function createMarkupCountryList(countries) {
    ...
    (0, _refs.getRefs)().countryList.innerHTML = textMarkup;
}
function createMarkupCountryCard(country) {
    clearCountryList();
    (0, _refs.getRefs)().countryInfo.classList.add("card");
    const countryCardMarkup = `
      <img src="${country[0].flags.svg}" class="card-img-top" alt="${country[0].name.official} flag">
      <div class="card-body">
        <h5 class="card-title">${country[0].name.official}</h5>
        <ul class="list-group list-group-flush">
          <li class="list-group-item"><span class="fw-bold">Capital: </span>${country[0].capital[0]}</li>
          <li class="list-group-item"><span class="fw-bold">Population: </span>${country[0].population}</li>
          <li class="list-group-item"><span class="fw-bold">Languages: </span>${tansformLanguagesToText(country[0].languages)}</li>
        </ul>
      </div>
  `;
    (0, _refs.getRefs)().countryInfo.innerHTML = countryCardMarkup;
}
function tansformLanguagesToText(languages) {
    ...
    for(language in languages){
        total += 1;
        if (total === languagesLength) languagesMarkup += languages[language];
        else languagesMarkup += languages[language] + ", ";
    }
    return languagesMarkup;
}
function fetchCountriesResponse(country, callbackSuccess, callbackFailure) {
    (0, _fetchCountries.fetchCountries)(country).then(callbackSuccess).catch(callbackFailure);
}
function fetchCountriesFailureResponse() {
    (0, _notiflixNotifyAio.Notify).failure("Oops, there is no country with such name.");
    clearCountryList();
    clearCountryInfo();
    (0, _refs.getRefs)().countryInfo.classList.remove("card");
}
function clearCountryList() {
    (0, _refs.getRefs)().countryList.innerHTML = "";
}
function clearCountryInfo() {
    (0, _refs.getRefs)().countryInfo.innerHTML = "";
}

},{"../css/styles.css":"1CY4s","./fetchCountries":"dKuy9","../styles.scss":"kMfPY","./refs":"2WoF2","lodash.debounce":"3JP5n","notiflix/build/notiflix-notify-aio":"eXQLZ","bootstrap":"h36JB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"dKuy9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"kMfPY":[function() {},{}],"2WoF2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequireabb0")
